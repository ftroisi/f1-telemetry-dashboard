    ...
    <Box className="flex items-center justify-between border-b border-gray-800 bg-[#1a1a2e] px-6 py-3">
      <Box className="flex items-center gap-4">
        <button
          ...
          className="flex cursor-pointer items-center gap-1.5 rounded-lg border border-gray-700 bg-[#161b22] px-3 py-1.5 text-sm text-gray-300 transition-all hover:border-gray-600 hover:text-white"
        >
      ...
      <Button
        ...
        className="!bg-racing-red-600 hover:!bg-racing-red-500 !flex !items-center !gap-2 !rounded-lg !px-4 !py-2 !text-sm !font-medium !text-white !transition-all"
      >
