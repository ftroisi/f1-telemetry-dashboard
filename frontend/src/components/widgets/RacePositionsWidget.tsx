...
export default function RacePositionsWidget({ sessionKey, driverNumbers }: RacePositionsWidgetProps) {
    ...
    <ResponsiveContainer width="100%" height="100%">
      <LineChart data={reversedData} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
        ...
        <XAxis
          ...
          stroke="#555"
          label={{ value: 'Time', position: 'insideBottom', fill: '#999', fontSize: 10, offset: -5 }}
        />
        <YAxis
          tick={{ fill: '#999', fontSize: 10 }}
          stroke="#555"
          label={{ value: 'Position', angle: -90, position: 'insideLeft', fill: '#999', fontSize: 10 }}
          domain={[1, 20]}
          reversed
          ticks={[1, 5, 10, 15, 20]}
        />
